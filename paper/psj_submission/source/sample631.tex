...
\begin{figure*}[htbp]
    ...
    \textit{Bottom row:} 5-component GMM applied to the distribution of the Mg\# proxy derived from $(\mathcal{R}^\text{Mg}_\text{Si} / [\mathcal{R}^\text{Mg}_\text{Si} + \mathcal{R}^\text{Fe}_\text{Si}])$, showing notable separation of Mare Moscoviense, Australe, Marginis, and Smythii, unseen previously.}}
    \label{fig:maps3}
\end{figure*}
